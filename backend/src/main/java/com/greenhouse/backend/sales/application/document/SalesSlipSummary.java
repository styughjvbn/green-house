...
public record SalesSlipSummary(Long id, String slipNumber, LocalDate saleDate, SalesType salesType,
	...
	public static SalesSlipSummary from(SalesSlip salesSlip, BusinessPartnerInfo partner, String auctionMarket) {
		return new SalesSlipSummary(salesSlip.getId(), salesSlip.getSlipNumber(), salesSlip.getSaleDate(),
