...
public record BedZoneCapacityResponse(Long id, String placementType, String potSize, PlacementCapacityMode capacityMode,
	...
	public static BedZoneCapacityResponse from(BedZoneCapacity capacity) {
		return new BedZoneCapacityResponse(capacity.getId(), capacity.getPlacementType(), capacity.getPotSize(),
				capacity.getCapacityMode(), capacity.getUnitSpan(), capacity.getCapacityValue(), capacity.getAllowed(),
				capacity.getMemo());
	}
}
