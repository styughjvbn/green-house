...
public interface OrchidGroupCollectionMemberRepository extends JpaRepository<OrchidGroupCollectionMember, Long> {
	...
	List<OrchidGroupCollectionMember> findByCollectionIdInAndRemovedAtIsNullOrderByJoinedAtAsc(
	...
	List<OrchidGroupCollectionMember> findByCollectionIdAndOrchidGroupIdInAndRemovedAtIsNull(Long collectionId,
			Collection<Long> orchidGroupIds);

	Optional<OrchidGroupCollectionMember> findByCollectionIdAndOrchidGroupIdAndRemovedAtIsNull(Long collectionId,
			Long orchidGroupId);
