...
public record TransformOrchidGroupMutationSource(Long orchidGroupId, Integer transformedQuantity,
	...
	public TransformOrchidGroupMutationSource {
		...
		if (releasedStartPosition != null && releasedEndPosition.compareTo(releasedStartPosition) <= 0) {
