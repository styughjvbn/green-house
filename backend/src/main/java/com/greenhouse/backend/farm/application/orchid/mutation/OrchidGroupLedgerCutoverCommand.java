...
public record OrchidGroupLedgerCutoverCommand(UUID cutoverKey, LocalDate effectiveBusinessDate,
		String minimumWriterVersion, String currentWriterVersion, boolean activate) {
	...
	public OrchidGroupLedgerCutoverCommand {
		...
		if (!OrchidGroupLedgerWriterVersion.satisfiesMinimum(currentWriterVersion, minimumWriterVersion)) {
