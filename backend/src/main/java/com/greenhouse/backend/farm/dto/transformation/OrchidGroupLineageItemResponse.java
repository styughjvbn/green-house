...
public record OrchidGroupLineageItemResponse(Long id, OrchidGroupLineageRelationType relationType, Long workOperationId,
		Integer sourceQuantity, Integer resultQuantity, LocalDateTime createdAt, OrchidGroupResponse sourceOrchidGroup,
	...
	public static OrchidGroupLineageItemResponse from(OrchidGroupLineage lineage, LocalDate businessDate) {
		return new OrchidGroupLineageItemResponse(lineage.getId(), lineage.getRelationType(),
				lineage.getWorkOperationId(), lineage.getSourceQuantity(), lineage.getResultQuantity(),
