...
/**
 * Farm-owned extension point for references that prevent cancellation or correction.
 * Keep inbound, sales, then work order: command errors use the first blocker's message.
 */
