...
public record WorkEffectCommand(LocalDateTime executedAt, String worker, Map<String, Object> resultDetails,
		Object payload, Set<Long> placementExclusionOrchidGroupIds, String effectKey) {

	public WorkEffectCommand(LocalDateTime executedAt, String worker, Map<String, Object> resultDetails,
			Object payload) {
		this(executedAt, worker, resultDetails, payload, Set.of(), null);
	}

	public WorkEffectCommand(LocalDateTime executedAt, String worker, Map<String, Object> resultDetails, Object payload,
	...
	public WorkEffectCommand withEffectKey(String effectKey) {
		return new WorkEffectCommand(executedAt, worker, resultDetails, payload, placementExclusionOrchidGroupIds,
				effectKey);
	}
