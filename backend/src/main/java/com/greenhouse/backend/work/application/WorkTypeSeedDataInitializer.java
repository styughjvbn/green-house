...
public class WorkTypeSeedDataInitializer implements CommandLineRunner {
	...
	private static final List<DefaultWorkType> DEFAULT_TYPES = List.of(
			...
			new DefaultWorkType("FLOWER_CLEANUP", "\ub2e8\ud654/\uaf43 \uc815\ub9ac", WorkTypeTemplate.CLEANUP, false,
					9),
			new DefaultWorkType(WorkType.MOVEMENT_CODE, "\uc704\uce58 \uc774\ub3d9", WorkTypeTemplate.MOVEMENT, true,
					10));
