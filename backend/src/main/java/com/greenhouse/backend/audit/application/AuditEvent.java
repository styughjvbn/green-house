...
public record AuditEvent(Identity identity, AuditAction action, AuditSource source, Target target,
	...
	public record Target(String entityType, Long entityId, Long houseId, Long physicalBedId, Long zoneId, Long varietyId) {
		public Target(String entityType, Long entityId) { this(entityType, entityId, null, null, null, null); }
	}
}
