...
public class AuctionSettlementController {
	...
	public ApiResponse<List<AuctionSettlementResponse>> getSettlements(
			@RequestParam(required = false) Long auctionHouseId, @RequestParam(required = false) LocalDate from,
	...
	@GetMapping("/page")
	@Operation(operationId = "getAuctionSettlementPage",
	...
	public ApiResponse<PageResponse<AuctionSettlementListItemResponse>> getSettlementPage(
			@RequestParam(required = false) Long auctionHouseId, @RequestParam(required = false) LocalDate from,
			@RequestParam(required = false) LocalDate to,
			@RequestParam(required = false) AuctionSettlementStatus status, @RequestParam(defaultValue = "0") int page,
	...
	public ApiResponse<AuctionSettlementSummaryResponse> getSummary(@RequestParam(required = false) Long auctionHouseId,
	...
	@PostMapping("/rebuild")
	public ApiResponse<AuctionSettlementResponse> rebuild(@RequestParam Long auctionHouseId,
