...
public class PaymentController {
	...
	public ApiResponse<AuctionSettlementResponse> confirmAuctionPayment(@PathVariable Long settlementId,
	...
	public ApiResponse<List<PartnerPaymentEventResponse>> getEvents(@RequestParam(required = false) Long partnerId,
	...
	@Operation(operationId = "getPaymentEventPage",
	...
	public ApiResponse<PageResponse<PartnerPaymentEventResponse>> getEventPage(
			...
			@RequestParam(required = false) PaymentTargetType targetType, @RequestParam(required = false) Long targetId,
			@RequestParam(required = false) PaymentEventType eventType, @RequestParam(defaultValue = "0") int page,
