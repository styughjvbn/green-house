...
public class BusinessPartnerController {
	...
	public ApiResponse<List<BusinessPartnerResponse>> getPartners(@RequestParam(required = false) String keyword,
	...
	public ApiResponse<PageResponse<BusinessPartnerResponse>> getPartnerPage(
			@RequestParam(required = false) String keyword, @RequestParam(required = false) PartnerType partnerType,
	...
	public ApiResponse<PageResponse<BusinessPartnerOptionResponse>> getOptions(
			@RequestParam(required = false) String keyword, @RequestParam(required = false) Boolean auctionHouse,
			@RequestParam(required = false) Boolean active, @RequestParam(defaultValue = "0") int page,
			@RequestParam(defaultValue = "10") int size) {
	...
	public ApiResponse<BusinessPartnerResponse> update(@PathVariable Long partnerId,
