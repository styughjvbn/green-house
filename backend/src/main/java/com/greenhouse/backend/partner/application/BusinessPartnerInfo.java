...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "id", "name", "partnerType", "ownerName", "phone", "address",
		"memo", "active" })
public record BusinessPartnerInfo(Long id, String name, PartnerType partnerType, boolean active, String ownerName,
		String phone, String address, String memo) {

	static BusinessPartnerInfo from(BusinessPartner partner) {
		return new BusinessPartnerInfo(partner.getId(), partner.getName(), partner.getPartnerType(), partner.isActive(),
