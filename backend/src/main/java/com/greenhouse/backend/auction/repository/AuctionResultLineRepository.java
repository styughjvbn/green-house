...
public interface AuctionResultLineRepository extends JpaRepository<AuctionResultLine, Long> {
	@EntityGraph(attributePaths = { "auctionAttempt", "auctionAttempt.shipmentLot", "auctionAttempt.shipmentLot.shipment" })
	@Query("""
			...
			""")
	List<AuctionResultLine> findSoldLines(@Param("auctionHouseId") Long auctionHouseId, @Param("auctionDate") LocalDate auctionDate);
