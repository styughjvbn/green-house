...
public record AuctionLotResponse(Long id, LocalDate shipmentDate, String auctionMarket, String itemName, String varietyName, String shipmentGrade, Integer boxes, Integer shippedQuantity, Integer soldQuantity, Integer waitingQuantity, Integer returnedQuantity, AuctionLotStatus currentStatus, LocalDate latestAuctionDate, Integer failedCount, Integer totalAmount, AuctionInspectionStatus inspectionStatus, String memo, List<AuctionAttemptResponse> attempts, List<AuctionStatusHistoryResponse> statusHistory) {
