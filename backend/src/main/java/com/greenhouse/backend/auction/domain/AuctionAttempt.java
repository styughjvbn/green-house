...
public class AuctionAttempt extends BaseEntity {
	...
	public AuctionAttempt(LocalDate date, Integer no, AuctionAttemptStatus status, String failedReason, String memo) {
		auctionDate = date;
		attemptNo = no;
	...
	void setShipmentLot(AuctionShipmentLot lot) {
		shipmentLot = lot;
	}

	public void addResultLine(AuctionResultLine line) {
		resultLines.add(line);
		line.setAuctionAttempt(this);
	}

	public void updateStatus(AuctionAttemptStatus status) {
		attemptStatus = status;
	}
	...
	public void recalculateStatus() {
		...
		if (hasReturn)
			...
			attemptStatus = AuctionAttemptStatus.PARTIALLY_SOLD;
		else if (hasSold)
			attemptStatus = AuctionAttemptStatus.SOLD;
		else
