...
class DemoRequestPolicyTest {
	...
	@CsvSource({
			...
			"PUT, /api/business-partners/42/settlement-settings/, true",
			"GET, /api/business-partners/42/settlement-settings, false",
			"PATCH, /api/business-partners/42, false",
			"POST, /api/work-types, true",
			"PATCH, /api/work-types/12, true",
			"DELETE, /api/work-types/12, true",
			"GET, /api/work-types, false",
			"POST, /api/work-operations, false"
	})
