  ...
  return (
    <main className="space-y-5">
      <section className="rounded-md border border-[#d7ddd4] bg-white p-4 shadow-sm">
        ...
        <p className="mt-1 text-sm text-[#5c6a60]">서비스 전체 글자 크기를 조정합니다.</p>
      </section>
      ...
      <section className="rounded-md border border-[#d7ddd4] bg-white p-5 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-[#5c6a60]">변경 즉시 전체 화면에 적용되고 브라우저에 저장됩니다.</p>
          </div>
        ...
        <div className="mt-5 space-y-4">
          ...
          <div className="rounded-md border border-[#d7ddd4] bg-[#f8faf7] p-4">
            ...
            <p className="mt-2 text-base text-[#1f2a24]">난 묶음, 작업 이력, 판매 전표 화면의 글자 크기가 같은 비율로 변경됩니다.</p>
          </div>
