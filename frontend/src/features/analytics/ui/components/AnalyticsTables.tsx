...
export function InsightsPanel({ items }: { items: SalesInsight[] }) {
  return (
...
function insightTone(tone: SalesInsight["tone"]) {
  return (
    {
...
function insightIcon(tone: SalesInsight["tone"]) {
  return (
    {
      green: TrendingUp,
      red: AlertTriangle,
