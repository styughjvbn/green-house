  ...
  return (
    <aside className="rounded-md border border-[#d7ddd4] bg-white p-3 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="rounded-full border border-[#d7ddd4] px-2 py-0.5 text-xs text-[#5c6a60]">
          15
        </span>
      </div>
          ...
          return (
            <Link
              ...
              className={`min-h-20 rounded-md border p-2 text-center shadow-sm transition hover:border-[#159447] ${
                selected
                  ? "border-[#159447] bg-[#eef7ec] ring-2 ring-[#159447]"
            ...
            >
              ...
              <p
                className={`mt-1 text-xs font-semibold ${warning ? "text-[#f59e0b]" : "text-[#159447]"}`}
              >
                {warning ? "주의" : "정상"}
              </p>
            </Link>
