...
export function PageHeader({
  ...
  return (
    <header className="full-bleed-header flex min-h-10 items-center justify-between gap-4 border-b border-[#edf0ec] bg-white px-4 py-3 shadow-[0_1px_8px_rgba(31,42,36,0.04)] md:px-5">
