...
export default async function DashboardPage() {
  ...
  const summaryItems = [
    ...
    { label: "물리 배드", value: `${summary.physicalBedCount}개`, tone: "border-[#3d6f91]" },
    { label: "논리 구역", value: `${summary.bedZoneCount}개`, tone: "border-[#b48235]" },
    { label: "난 묶음", value: `${summary.orchidGroupCount}개`, tone: "border-[#5c7894]" },
  ];
    ...
    <main className="space-y-8">
      <section className="space-y-2">
        ...
        <p className="max-w-3xl text-lg text-[#5c6a60]">
          전체 농장 구조와 난 묶음 분포를 조회합니다. 데이터 변경 작업은 전용 관리 화면에서 진행합니다.
        </p>
      </section>
